...
{
    /// <summary>
    /// Класс, содержащий необходимые для расчёта теоретического распределения примеси методы.
    /// </summary>
    public static class TheorDistrib
    {
        /// <summary>
        ...
        /// <summary>
        /// Расчёт распределения примеси.
        /// </summary>
        /// <param name="a">Амплитуда. Обычно – С0.</param>
        /// <param name="x">Аргумент erfc.</param>
        /// <returns></returns>
        public static double Cfunc(double a, double x)
        {
            return a * Erfc(x);
        }
    }
